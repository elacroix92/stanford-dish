...
This repository (repo) contains the code and data to reproduce all results and figures in the 2022 Geoderma publication: **Contributions of anoxic microsites to soil carbon protection across soil textures**. 

`StanfordDish_AllData.xlsx` contains all of the data from this study.

The R Markdown files are configured to read directly from the spreadsheet on the user's desktop. 
...
* `GeneralSoilProperties.md` shows data processing for texture, aggregate size, total C, and total N
* `DensityFrac.md` shows data processing for the density fractionation data
